...
function checkLogin() { //the login system... I actually need to encrypt this somehow
    ...
    var userusername = document.getElementById('username').value; //the username input
    var userpassword = document.getElementById('password').value; //the password input
    ...
    connection.connect((err) => {
        ...
        const userquery = `SELECT * FROM users where username = '${userusername}' AND password = '${userpassword}';`;
