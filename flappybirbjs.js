...
function checkLogin() {
    ...
    if (username === 'ThePoop3000' && password === 'Bird-Book-Poop') { //Preston
    ...
    else if (username === 'Dannythepro' && password === 'Dannythepro1212') { //Danny
        loginStatus.innerHTML = 'Login successful!';
        //window.location.href = 'flappybirb.html';
        watters();
    }
...
function watters() {
    message.innerHTML = '<p>Enter to start flappycat!!! <p><span style = "color:wheat">&uarr;</span>uparrow to control cat</p>';
    message.classList.add('messageStyle');
